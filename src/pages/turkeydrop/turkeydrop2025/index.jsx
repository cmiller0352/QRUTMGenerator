  ...
  return (
    <main className="tdp-shell">
      <section className="tdp-left">
        <div className="crumb">Road Home Program — Effingham</div>
        <h1 className="tdp-title">TURKEY DROP <span className="tdp-year">2025</span></h1>
        ...
        <div className="tdp-block">
          <h3>When</h3>
          <p>Saturday, November 23rd<br/>11:00 am — 2:00 pm (choose a pickup window)</p>
        </div>
...
function ReservationCard() {
  return (
    <article className="tdp-card">
      ...
      {/* SlotPicker contains the entire form, including Turnstile + submit */}
      <SlotPicker eventId={EVENT_ID} />
      <p className="tdp-help">
        Having trouble? Call <a href="tel:217-347-3552">217-347-3552</a> and our team will register you by phone.
      </p>
    </article>
  );
}
